...
$this['asset']->addFile('js', 'js:jquery.matchheight.js');
$this['asset']->addFile('js', 'js:form-validator/jquery.form-validator.min.js');
$this['asset']->addFile('js', 'js:custom.js');

// internet explorer
if ($this['useragent']->browser() == 'msie') {
    $head[] = sprintf('<!--[if IE 8]><link rel="stylesheet" href="%s"><![endif]-->', $this['path']->url('css:ie8.css'));
    $head[] = sprintf('<!--[if IE]><link rel="stylesheet" href="%s"><![endif]-->', $this['path']->url('css:ie.css'));
