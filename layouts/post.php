...
<?php else : ?>
    ...
    <?php if (has_post_thumbnail()) : ?>
        ...
        $height = get_option('thumbnail_size_h'); //get the height of the thumbnail setting
        ?>
        <a class="image_float_left" href="<?php the_permalink() ?>" title="<?php the_title_attribute(); ?>"><?php the_post_thumbnail(array($width, $height), array('class' => '')); ?></a>
    <?php endif; ?>
...
<?php endif; ?>
    ...
    <div class="align_justify"><?php the_content(''); ?></div>
