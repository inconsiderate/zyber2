...
<body class="<?php echo $this['config']->get('body_classes'); ?>">
    ...
    <div class="uk-container uk-container-center">
        ...
        <?php if ($this['widgets']->count('My-sidebar')) : ?>
        <section id="tm-My-sidebar" class="<?php echo $grid_classes['My-sidebar']; echo $display_classes['My-sidebar']; ?>" data-uk-grid-match="{target:'> div > .uk-panel'}" data-uk-grid-margin>
            <?php echo $this['widgets']->render('My-sidebar', array('layout'=>$this['config']->get('grid.My-sidebar.layout'))); ?>
        </section>
        <?php endif; ?>
